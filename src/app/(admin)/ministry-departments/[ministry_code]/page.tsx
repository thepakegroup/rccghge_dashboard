    ...
    <section className="relative px-4 mb-8 mt-8">
      <GoBack
        header={(params.ministry_code as string)
          ...
          .toUpperCase()}
      />
      <div className="absolute flex justify-center bg-[#e3e6eb] z-50 top-10 left-0 w-full h-full">
        <svg width="100%" height="100">
          <text
            ...
            strokeWidth="1"
            fill="transparent"
            className="text-2xl sm:text-3xl md:text-4xl font-quicksand"
          >
            Ministry code not valid
          </text>
        </svg>
      </div>
      {/*  */}
...
export default DynamicMinistryPage;
