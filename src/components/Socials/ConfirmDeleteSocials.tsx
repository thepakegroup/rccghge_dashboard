...
const ConfirmDeleteSocials = ({
  ...
  const handleDelete = async () => {
    ...
    try {
      const res = await remove(`social-connect/${selectedAccount?.id}`);
      ...
      updateToast({
        title: `Error! Social post not deleted.`,
        type: "error",
...
export default ConfirmDeleteSocials;
