...
import { OurMissionPageSchema } from "@/helper/schema";
...
const OurMission = () => {
  ...
  const {
    ...
    url: `page-setting/info?name=our_mission`,
    method: "client",
  });
  ...
  const {
    ...
    resolver: yupResolver(OurMissionPageSchema),
  });
  ...
  const onOurMissionPageSubmit: SubmitHandler<{
    header_text: string;
  ...
  return (
    <div className="flex flex-col gap-[35px]">
      ...
      <form
        onSubmit={handleSubmit(onOurMissionPageSubmit)}
