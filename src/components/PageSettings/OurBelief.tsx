...
const OurBelief = () => {
  ...
  const {
    ...
    url: `page-setting/info?name=our_beliefs`,
    method: "client",
  });
  ...
  const {
    ...
    resolver: yupResolver(OurBeliefPageSchema),
  });
  ...
  const onOurBeliefPageSubmit: SubmitHandler<{
    header_text: string;
  ...
  return (
    <div className="flex flex-col gap-[35px]">
      ...
      <form
        onSubmit={handleSubmit(onOurBeliefPageSubmit)}
