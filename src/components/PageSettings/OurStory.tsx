...
const OurStory = () => {
  ...
  const {
    ...
    url: `page-setting/info?name=our_story`,
    method: "client",
  });
  ...
  const {
    ...
    resolver: yupResolver(OurStoryPageSchema),
  });
  ...
  const onOurStoryPageSubmit: SubmitHandler<{
    header_text: string;
  ...
  return (
    <div className="flex flex-col gap-[35px]">
      ...
      <form
        onSubmit={handleSubmit(onOurStoryPageSubmit)}
