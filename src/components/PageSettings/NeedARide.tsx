...
import { NeedARidePageSchema } from "@/helper/schema";
...
const NeedARide = () => {
  ...
  const {
    ...
    url: `page-setting/info?name=need_a_ride`,
    method: "client",
  });
  ...
  const {
    ...
    resolver: yupResolver(NeedARidePageSchema),
  });
  ...
  const onNeedARidePageSubmit: SubmitHandler<{
    header_text: string;
  ...
  return (
    <div className="flex flex-col gap-[35px]">
      ...
      <form
        onSubmit={handleSubmit(onNeedARidePageSubmit)}
